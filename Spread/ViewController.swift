...
class ViewController: UIViewController {
    ...
    func initData() {
        ...
        carrotInPool1.property("name", on: .onChange) { [weak self] (oldValue, newValue) -> Void in
        ...
        carrotInPool2.property("name", on: .onChange) { [weak self] (oldValue, newValue) -> Void in
        ...
        carrotInPool3.property("name", target: self, selector: #selector(ViewController.textChange), on: .onChange)
    }
